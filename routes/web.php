...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/delete_announcement/{id}', [AnnouncementController::class, 'deleteAnnouncement']);
    ...
    Route::middleware(['user-role:1'])->group(function () {
        ...
        Route::post('/student_list/edit/commit/{student_id}', [UserController::class, 'UpdateData']);
        ...
        Route::post('/updateEvaluationForm', [EvaluationController::class, 'updateEvaluationForm']);
        ...
        Route::post('/delete_event/{event}', [EventController::class, 'destroy'])->name('events-destroy');
        ...
        Route::post('/update_event/{event}', [EventController::class, 'update'])->name('events-update');
        ...
        Route::post('/update_event_attendance_status/{event_id}/{status}', [AccountabilitiesController::class, 'updateEventAttendanceStatus']);
        ...
        Route::post('/delete_organization_accountability/{accountability_id}/{org_id}', [AccountabilitiesController::class, 'DeleteOrganizationAccountability']);
        ...
        Route::post('/update_accountabilities/{id}/{old_name}/{org_id}', [AccountabilitiesController::class, 'updateAccountabilities']);
        ...
        Route::post('/delete_paid_accountabilities/{accountability_id}', [AccountabilitiesController::class, 'deletePaidAccountabilities']);
        ...
        Route::post('/update_officer/{id}', [OrgProfileController::class, 'updateOfficer']);
        Route::post('/deleteOfficer/{id}', [OrgProfileController::class, 'DeleteOfficer']);
        ...
        Route::post('/update_officer_role/{id}', [OrgProfileController::class, 'updateOfficerRole']);
        Route::post('/delete_officer_role/{id}', [OrgProfileController::class, 'DeleteOfficerRole']);
        ...
        Route::post('/delete_year_level/{id}', [OrgProfileController::class, 'DeleteYearLevel']);
        Route::get('/year_level_fetch_update/{id}', [OrgProfileController::class, 'yearLevelFetchUpdate']);
        Route::post('/update_year_level/{id}', [OrgProfileController::class, 'updateYearLevel']);
    ...
    Route::middleware(['user-role:2'])->group(function () {
        ...
        Route::post('updateEmail/{email}', [UserController::class, 'updateEmail']);
        //get user organization
    ...
    Route::middleware(['user-role:4'])->group(function () {
        ...
        Route::post('/update_school_year/{id}', [AdminController::class, 'updateSchoolYear']);
        Route::post('/deleteSchoolYear/{id}', [AdminController::class, 'DeleteSchoolYear']);
        Route::post('/add_college', [AdminController::class, 'addCollege']);
        Route::get('/edit_college/{id}', [AdminController::class, 'fetchCollegeEdit']);
        Route::post('/update_college/{id}', [AdminController::class, 'updateCollege']);
        Route::post('/delete_college/{id}', [AdminController::class, 'deleteCollege']);
        ...
        Route::post('/update_organization/{id}', [AdminController::class, 'updateOrganization']);
        Route::post('/delete_organization/{id}', [AdminController::class, 'deleteOrganization']);
