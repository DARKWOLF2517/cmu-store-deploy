                    ...
                    <div>
                        <p class="d-flex align-items-center text-dark text-decoration-none " aria-expanded="false">
                            ...
                            <img v-else src="https://indonesiasatu.co.id/assets/themes/indonesiasatu/img/user.png"
                                alt="user-image" width="32" height="32" class="rounded-circle me-2">
                            <span class="profile-name"><strong>{{ this.selectedAnnouncement.organization
                                    }}</strong></span>
                        </p>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <small class="text-mute">Date and time posted: {{ this.selectedAnnouncement.date }} {{
        this.selectedAnnouncement.time }} </small>
                        <p class="mt-2">{{ this.selectedAnnouncement.description }}</p>
                    </div>
...
export default {
    ...
    methods: {
        ...
        openModal(announcement) {
            ...
            this.selectedAnnouncement.organization = announcement.organization.name;
