    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <div class="event-buttons d-flex">
        <div class="btn-group" role="group">
          <button class="btn me-2" id="btn-accountabilities" data-bs-toggle="modal" data-bs-target="#membershipFeeModal"
      ...
      <div class="accountability-card border-top border-5 border-success border-bottom-0"
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="ellipsisDropdown">
            <!-- option 1 -->
            <li
              @click="this.id = accountability.accountability_id, submit = this.updateAccountabilities, this.accountabilitiesFetchUpdate()"
              data-bs-toggle="modal" data-bs-target="#membershipFeeModal"><a class="dropdown-item">Edit Accountability</a>
            </li>
            <!-- option 2 -->
      ...
      <div class="modal-content">
        <form @submit.prevent="submit" id="eventsForm">
          <div class="modal-header">
            <h5 class="modal-title" id="membershipFeeModalLabel" v-if="submit == this.submitData">Add Accountabilities
            </h5>
            <h5 class="modal-title" id="membershipFeeModalLabel" v-else-if="submit == this.updateAccountabilities">Edit
              Accountabilities</h5>
