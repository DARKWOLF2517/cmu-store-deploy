            ...
            <td>
              <span class="table-buttons">
                <button class="btn edit-button"
                  @click="submit = updateData, id = free_fines.student_id, fetchUpdateData()" data-bs-toggle="modal"
                  data-bs-target="#addStudentModal"><i class="fas fa-pen"></i></button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer ">
          ...
          <button type="button" class="btn btn-danger" @click="this.deleteStudentData()" data-bs-dismiss="modal">Confirm
            Delete</button>
        </div>
      </div>
    </div>
