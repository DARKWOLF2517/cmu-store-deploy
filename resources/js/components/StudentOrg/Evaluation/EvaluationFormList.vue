        ...
        <div id="evaluation-container">
            <div class="evaluation-event-cards">
                <div class="event-card" style="width: 45vh !important; border-left-style: solid; border-left-color: #1b9587;">
                    ...
                    <div class="dropdown">
                    <a class="ellipsis-button" href="#" style="color: #3e505d;" role="button" id="ellipsisDropdown" data-bs-toggle="dropdown" aria-expanded="false">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="d-flex justify-content-end mb-3">
            <button type="button" class="btn btn-light add-question" @click="addQuestion"> <i class="fas fa-plus"></i> Add Question</button>
          </div>
          <div class="question-container">
            <div class="mb-3" v-for="(question, index) in questions" :key="index">
              ...
              <div class="mb-3 mt-2 form-check">
                <input type="checkbox" class="form-check-input" :id="'multipleChoice' + (index + 1)" v-model="question.multipleChoice">
