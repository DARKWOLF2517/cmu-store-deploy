                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#addSchoolYearModal"><i
                                        class="fas fa-plus"></i> Add School Year</button>
                            </div>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <button class="btn btn-danger text-light" data-bs-toggle="modal"
                                                        data-bs-target="#deleteSYConfirmation"><i
            ...
            <div class=" col-md-6 ">
                <div class="card border-0 p-2">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#addCollegeModal"><i
                                class="fas fa-plus"></i> Add College</button>
                    </div>
                    <div class="table-container">
                        <table class="table">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <button class="btn btn-danger text-light" data-bs-toggle="modal"
                                                data-bs-target="#deleteCollegeConfirmation"><i
                                                    class="fas fa-trash"></i></button>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div class="col">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <button class="btn btn-light" data-bs-toggle="modal"
                                    data-bs-target="#addOrganizationModal"><i class="fas fa-plus"></i> Add
                                    Organization</button>
                            </div>
                            <div class="table-container">
                                <table class="table">
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <button class="btn btn-warning text-light"><i
                                                            class="fas fa-edit"></i></button>
                                                    <button class="btn btn-danger text-light" data-bs-toggle="modal"
                                                        data-bs-target="#deleteOrganizationConfirmation"><i
                                                            class="fas fa-trash"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <button class="btn btn-warning text-light"><i class="fas fa-edit"></i></button>
                                            <button class="btn btn-danger text-light"><i class="fas fa-trash"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#deleteUserConfirmation"></i></button>
                                        </div>
                                    </td>
