    ...
    <form @submit.prevent="this.checkNewPassword" class="login-form">
        ...
        <div class="form-group mt-3">
            ...
            <div class="input-group">
                <input type="password" class="form-control rounded-left" placeholder="Current Password" required
                    name="password" v-model="change_password_data.current_password">
            </div>
        </div>
        <div class="form-group">
            <b>Enter new Password</b>
            <div class="input-group">
                <input type="password" id="newPassword" class="form-control rounded-left" placeholder="New Password"
                    required name="password" v-model="change_password_data.new_password">
            </div>
        ...
        <div class="input-group">
            <input type="password" class="form-control rounded-left" placeholder="Retype New Password" required
                name="password" v-model="change_password_data.confirm_new_password">
        </div>
